...
let app: RealmSwift.App? = App(id: Bundle.main.object(forInfoDictionaryKey:"APP_ID") as! String, configuration: AppConfiguration(transport: nil, localAppName: nil, localAppVersion: nil));
